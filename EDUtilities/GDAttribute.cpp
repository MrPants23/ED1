...
void GDAttributeBase::ReadAabbXML(TiXmlElement* elementPtr, EDCollision::Aabb* aabbPtr)
{
...
void GDAttributeBase::ReadSphereXML(TiXmlElement* elementPtr, EDCollision::Sphere* spherePtr)
{
