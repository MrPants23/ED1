...
public:
	...
	static void ReadAabbXML(TiXmlElement* elementPtr, EDCollision::Aabb* aabbPtr);
	static void ReadSphereXML(TiXmlElement* elementPtr, EDCollision::Sphere* spherePtr);
...
class GDAttribute : public GDAttributeBase
{
	...
	std::vector< Type, MMAllocator<Type> > values;
