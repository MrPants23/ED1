...
namespace EDGOCA
{
	...
	class ComponentSystem
	{
		...
		map< AttributeTypeKey, AttributeCreator > attributeCreatorMap;
		map< AttributeNameKey, AttributeTypeKey > attributeNameTypeMap;

		StringTable behaviorNameStringTable;
		map< BehaviorNameKey, BehaviorCreator > behaviorCreatorMap;
