...
namespace Behaviors
{
	...
	{
		AddMessageHandler( MessageHandler( MSG_SET_LIGHT, OnSetLight ) );
		AddMessageHandler( MessageHandler( MSG_SET_LIGHT_CONTEXT, OnSetRenderContext ) );
	...
	void LightController::OnSetLight( IBehavior* pInvokingBehavior, IMessage* msg )
	{
		...
		MessageT<Light *>* message = (MessageT<Light *>*)msg;

		lightBehaviorPtr->lightPtr = (Light *)message->value;
